...
class CreateAuthTables extends Migration
{
    public function up()
    {
        ...
        $this->forge->addField([
            ...
            'fullname'                => ['type' => 'varchar', 'constraint' => 128, 'null' => true], // Nama Lengkap
            'employee_id'             => ['type' => 'decimal', 'constraint' => 65, 'null' => true],  // NIP
            'employee_position'       => ['type' => 'text', 'null' => true],                         // Jabatan Pegawai
            'regional_work_unit_id'   => ['type' => 'decimal', 'constraint' => 65, 'null' => true],  // ID SKPD
            'regional_work_unit_name' => ['type' => 'text', 'null' => true],                         // Nama/Detail SKPD
        ]);
