...
class Auth extends AuthConfig
{
	 ...
	 */
	public $views = [
		'login'		      => '\Acme\Auth\Views\login',
		'register'		  => '\Acme\Auth\Views\register',
		'forgot'		  => '\Acme\Auth\Views\forgot',
		'reset'		      => '\Acme\Auth\Views\reset',
		'emailForgot'	  => '\Acme\Auth\Views\emails\forgot',
		'emailActivation' => '\Acme\Auth\Views\emails\activation',
	];
	 ...
	 * @var string
	 */
	public $viewLayout = '\Acme\Auth\Views\layout';
